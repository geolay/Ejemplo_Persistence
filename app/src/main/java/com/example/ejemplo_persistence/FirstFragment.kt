...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mbinding.botonGuardar.setOnClickListener {
            if(mbinding.ingresaEntero.text.toString().isEmpty()){
                Toast.makeText(this.activity,"Debe Ingresar Datos",Toast.LENGTH_SHORT).show()
            }
            else if (mbinding.ingesaTexto.text.toString().isEmpty()){
                Toast.makeText(this.activity,"Debe Ingresar Datos",Toast.LENGTH_SHORT).show()
            }
            else if  (mbinding.ingresaDecimal.text.toString().isEmpty()){
                Toast.makeText(this.activity,"Debe Ingresar Datos",Toast.LENGTH_SHORT).show()
            }
            else {
